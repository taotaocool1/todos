  ...
  render() {
    ...
    return (
      <li className="addsContent" data-index={this.props.isCheck} onMouseOver={this.handlerMouseOver.bind(this)} onMouseOut={this.handlerMouseOut.bind(this)}>
        <span><label className="changeCheck">{<span style={showCheck} className="checkIcon">&#10003;</span>}<input id="checkboxs1" className="checkboxs" type="checkbox" checked={this.props.isCheck} onChange={this.handlerChange.bind(this)} />
        </label></span>
